<div class="result-top-first">
  <div>
    ...
    <div class="desc-title">역발상이 취미인 청개구리</div>
  </div>
    ...
    <div>
      <div>
        <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="7rem" height="7rem" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle class="circle-chart__circle" stroke="#f58220" stroke-width="3" stroke-dasharray="45.8,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15" />
          <g class="circle-chart__info">
