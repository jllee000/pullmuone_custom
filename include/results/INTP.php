<div class="result-top-first">
  <div>
    ...
    <div class="desc-title">꿈만 큰 몽상가</div>
  </div>
...
<div class="result-top-desc">
  ...
  <div class="doughnut-chart">
    <div>
      ...
      <div class="chart-cate">자기애</div>
    </div>
    <div>
      <div>
        <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="7rem" height="7rem" xmlns="http://www.w3.org/2000/svg">
          <circle class="circle-chart__background" stroke="#f582204d" stroke-width="3" fill="none" cx="17" cy="17" r="15" />
          <circle class="circle-chart__circle" stroke="#f58220" stroke-width="3" stroke-dasharray="25,100" stroke-linecap="round" fill="none" cx="17" cy="17" r="15" />
          <g class="circle-chart__info">
            <text class="circle-chart__percent" x="16.91549431" y="17.5" alignment-baseline="central" text-anchor="middle" font-size="8.5">30%</text>
          </g>
        </svg>
      </div>
